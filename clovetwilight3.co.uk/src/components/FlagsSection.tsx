...
const flags: Flag[] = [
  ...
  {
    src: "https://yuri-lover.win/cdn/flags/transfeminine.png",
  ...
  {
    src: "https://yuri-lover.win/cdn/flags/therian.png",
    alt: "Therian Flag",
    description: "Therian",
