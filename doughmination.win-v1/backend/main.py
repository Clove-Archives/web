...
from auth import router as auth_router, get_current_user, oauth2_scheme, verify_turnstile_token
from tags import (
...
from discord_bot_api import router as bot_router
from bot_tokens import initialize_bot_token
...
async def upload_user_avatar(
    ...
    try:
        ...
        if "doughmination.win" in base_url and not base_url.startswith("https://www."):
            base_url = base_url.replace("https://doughmination.win", "https://doughmination.win")
            base_url = base_url.replace("http://doughmination.win", "https://doughmination.win")
...
<head>
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://doughmination.win/fronting" />
    ...
    {{
      ...
      "itemListElement": [
        {{
          ...
          "position": 1,
          "name": "Home",
          "item": "https://doughmination.win/"
        }},
        {{
          "@type": "ListItem",
          "position": 2,
          "name": "Current Fronters",
          "item": "https://doughmination.win/fronting"
        }}
      ]
    }}
    </script>
...
async def serve_member_page(member_name: str, request: Request):
    ...
    {{
      ...
      "memberOf": {{
        ...
        "url": "https://doughmination.win/",
        "logo": "https://yuri-lover.win/cdn/pfp/fallback_avatar.png"
      }}
    }}
    </script>"""
...
<head>
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://doughmination.win/{member_name}" />
    ...
    {{
      ...
      "itemListElement": [
        ...
        {{
          ...
          "position": 2,
          "name": "{display_name}",
          "item": "https://doughmination.win/{member_name}"
        }}
      ]
    }}
    </script>
